  ...
  return (
    <div className="px-6 md:px-12 lg:px-24 py-10" >
      ...
      <div className="text-center bg-gradient-to-r
         from-teal-900 to-emerald-400 bg-clip-text text-transparent">
      ...
      <div className="mt-28 ">
        <div className="text-center text-xl font-semibold text-gray-800">
         ...
         from-teal-900 to-emerald-400 bg-clip-text text-transparent">Vision</span>
        </div>
      ...
      <div className="mt-28 flex flex-col md:flex-row gap-16 items-center">
        <div className="md:w-3/5 text-base text-gray-700 leading-relaxed">
          <h2 className="text-lg font-semibold text-gray-800">
            Our <span className="bg-gradient-to-r
         from-teal-900 to-emerald-400 bg-clip-text text-transparent">Story</span>
          </h2>
          <p className="mt-4">
      ...
      <div className="my-12 mt-32">
        <div className="text-center text-xl font-semibold text-gray-800">
          Why <span className="bg-gradient-to-r
         from-teal-900 to-emerald-400 bg-clip-text text-transparent">Choose us</span>
        </div>
      </div>

      <div className="flex flex-col md:flex-row gap-6 mb-20">
        <div className="border px-6 md:px-12 py-8 flex-1 text-center rounded-lg shadow-lg hover:bg-gradient-to-r
         from-teal-900 to-emerald-400 hover:text-white transition-all duration-500">
