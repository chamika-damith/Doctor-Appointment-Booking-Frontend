      ...
      <div className="flex bg flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        <div className="w-full grid grid-cols-auto gap-4 gap-y-6">
        {
          filterDoc.map((item,index)=>(
            <div onClick={()=>navigate(`/appoinments/${item._id}`)} key={index} className='border border-gray-200 rounded-2xl overflow-hidden cursor-pointer shadow-lg transition-transform duration-500 hover:-translate-y-2 hover:shadow-xl'>
